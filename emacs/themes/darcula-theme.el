...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default
               ...
               (region :background ,str :foreground ,dracula-bg)
               ...
               (company-preview :background ,dracula-bg :foreground ,key2)
               (company-preview-common :foreground ,bg2 :foreground ,fg3)
               (company-preview-search :foreground ,type :background ,dracula-bg)
               ...
               (gnus-group-mail-low :foreground ,bg4 :bold t)
               ...
               (gnus-group-news-low :foreground ,bg4 :bold t)
               ...
               (gnus-summary-normal-read :foreground ,bg4 :weight normal)
               ...
               (helm-buffer-not-saved :foreground ,type :background ,dracula-bg)
               (helm-buffer-process :foreground ,builtin :background ,dracula-bg)
               ...
               (helm-ff-directory :foreground ,func :background ,dracula-bg :weight bold)
               (helm-ff-executable :foreground ,key2 :background ,dracula-bg :weight normal)
               (helm-ff-file :foreground ,dracula-fg :background ,dracula-bg :weight normal)
               (helm-ff-invalid-symlink :foreground ,key3 :background ,dracula-bg :weight bold)
               (helm-ff-prefix :foreground ,dracula-bg :background ,keyword :weight normal)
               (helm-ff-symlink :foreground ,keyword :background ,dracula-bg :weight bold)
               ...
               (helm-grep-running :foreground ,func :background ,dracula-bg)
               (helm-header :foreground ,fg2 :background ,dracula-bg :underline nil :box nil)
               (helm-moccur-buffer :foreground ,func :background ,dracula-bg)
               (helm-selection :background ,bg2 :underline nil)
               (helm-selection-line :background ,bg2)
               (helm-separator :foreground ,type :background ,dracula-bg)
               (helm-source-go-package-godoc-description :foreground ,str)
               (helm-source-header :foreground ,keyword :background ,dracula-bg :underline nil :weight bold)
               (helm-time-zone-current :foreground ,builtin :background ,dracula-bg)
               (helm-time-zone-home :foreground ,type :background ,dracula-bg)
               ...
               (isearch-fail :foreground ,dracula-bg :background ,warning)
               ;; jde-java
               ...
               ;; mode-line
               (mode-line :foreground nil :background ,bg4 :box ,bg4)
               ...
               (diredp-deletion-file-name :foreground ,keyword :background ,bg4)
               ...
               (diredp-flag-mark-line :foreground ,fg2 :slant italic :background ,bg4)
               (diredp-flag-mark :foreground ,fg2 :weight bold :background ,bg4)
